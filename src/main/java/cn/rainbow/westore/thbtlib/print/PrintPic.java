...
import cn.rainbow.westore.thbtlib.R;
...
//        this.paint.setStyle(Paint.Style.STROKE);
    ...
    public Bitmap getGrayBitmap(Context context, Bitmap mBitmap) {
//        int delta = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1.65f, context.getResources().getDisplayMetrics());
        float delta = 1.5f;
        int dstWidth = (int)((float)mBitmap.getWidth() / delta );
        int dstHeight =  (int)((float)mBitmap.getHeight() / delta);
        Bitmap mGrayBitmap = Bitmap.createBitmap(dstWidth, dstHeight, Bitmap.Config.RGB_565);
...
//        mPaint.setColorFilter(mColorFilter);
        ...
        Rect dst = new Rect(0, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1f, context.getResources().getDisplayMetrics()),
                dstWidth - (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1.5f, context.getResources().getDisplayMetrics()),
                dstHeight - (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0.5f, context.getResources().getDisplayMetrics()));
        mCanvas.drawRect(0.0f, 0.0f, dstWidth,dstHeight, mPaint);
